function [ptrPanel,ptrSliderFrame,ptrEditFrame] = ETP_genMovieSlider(ptrMainGUI,vecLocation)
	...
	ptrSliderFrame= uicontrol('Style','Slider','Parent',ptrPanel,...
		...
		'Value',1,'Min',1,'Max',sETP.intF,'SliderStep',[1 5]./sETP.intF,...
		'Callback',{@ETP_GetCurrentFrame,'Slider'});
	...
	ptrEditFrame= uicontrol('Style','edit','Parent',ptrPanel,...
		...
		'Callback',{@ETP_GetCurrentFrame,'Edit'});
