function [eout,thresh,gv_45,gh_135,matGrad] = getEdge(varargin)
%GETEDGE Find edges in intensity image.
...
if ~any(strcmp(method,{'sobel','roberts','prewitt','canny'})) && (nargout>2)
